  ...
  issues.forEach((issue) => {
    ...
    card.innerHTML = `
        <div>
            ...
            <h3 class="font-bold text-slate-700 text-md mb-2 line-clamp-1">${issue.title}</h3>
...
const displayIssueModal = (issue) => {
  ...
  if (issue.priority.toLowerCase() === "high") pColor = "bg-red-500";
  if (issue.priority.toLowerCase() === "medium") pColor = "bg-orange-400";
  badge.className =
